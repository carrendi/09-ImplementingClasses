...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        distance = (((og_x - self.x)**2)+(og_y - self.y) ** 2) ** 0.5
    ...
    def get_distance_from_start(self):
        distance = (((self.startx - self.x) ** 2)+ (self.starty - self.y) ** 2) ** 0.5
        return distance
    ...
    def closer_to(self, p2, p3):
        distance_from_p2 = (((p2.x - self.x) ** 2) + ((p2.y - self.y) ** 2)) ** 0.5
        distance_from_p3 = (((p3.x - self.x) ** 2) + ((p3.y - self.y) ** 2)) ** 0.5
